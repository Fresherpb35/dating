              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs sm:text-sm">
                  <thead className="bg-pink-600 text-white">
                    <tr>
                      <th className="p-2 sm:p-3 min-w-[40px]"># </th>
                      <th className="p-2 sm:p-3 min-w-[80px]">User ID</th>
                      <th className="p-2 sm:p-3 min-w-[80px]">Reel ID</th>
                      <th className="p-2 sm:p-3 min-w-[120px] sm:min-w-[200px]">Comment</th>
                      <th className="p-2 sm:p-3 min-w-[100px]">Created At</th>
                    </tr>
                  </thead>
                  <tbody>
                    {comments.map((c, idx) => (
                      ...
                      >
                        ...
                        <td className="p-2 sm:p-3 text-gray-800 truncate max-w-[120px] sm:max-w-[200px]">
                          {c.comment_text}
                        </td>
                        <td className="p-2 sm:p-3 text-gray-500 text-xs sm:text-sm">
